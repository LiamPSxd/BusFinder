...
public final class TarjetaAlertaBinding implements ViewBinding {
  @NonNull
  ...
  private TarjetaAlertaBinding(@NonNull FrameLayout rootView, @NonNull BlurLayout blurLayout,
  ...
  @NonNull
  public static TarjetaAlertaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TarjetaAlertaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.tarjeta_alerta, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TarjetaAlertaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TarjetaAlertaBinding((FrameLayout) rootView, blurLayout, btnAceptar, dragArea,
