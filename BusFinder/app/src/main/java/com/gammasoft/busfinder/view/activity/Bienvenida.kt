...
class Bienvenida: AppCompatActivity(){
    ...
    private lateinit var evento: com.gammasoft.busfinder.controller.BienvenidaEvento
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        evento = com.gammasoft.busfinder.controller.BienvenidaEvento(this, binding)
